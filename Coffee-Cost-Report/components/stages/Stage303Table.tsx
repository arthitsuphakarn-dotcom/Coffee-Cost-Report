...
import { FG_UNIT_WEIGHT_GRAMS } from "@/lib/core/fgUnitWeights";
import type { Order303Report } from "@/lib/core/types";
import { inputCell, roleBorder, td, tdNum, tfootCell, tfootNum, th } from "../shared/reportTableStyles";

/**
 * Table for sheet 303's formulas that are actually MB51-derivable
 * (ราคาต่อหน่วย/Yield/Loss) — see lib/reports/pivot.ts. Yield needs each output
